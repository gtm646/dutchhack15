...
public class Company {
	...
	/**
	 * @param vestigingsnummer the vestigingsnummer to set
	 */
	...
	/**
	 * @param statutoryNames the statutoryNames to set
	 */
	...
	/**
	 * @param legalFormDescription the legalFormDescription to set
	 */
	...
	/**
	 * @param hasEntryInCommercialRegister the hasEntryInCommercialRegister to set
	 */
	...
	/**
	 * @param isEstablishment the isEstablishment to set
	 */
	...
	/**
	 * @param isMainEstablishment the isMainEstablishment to set
	 */
	...
	/**
	 * @param mainActivitySbiCode the mainActivitySbiCode to set
	 */
	...
	/**
	 * @param mainActivitysbiCodeDescription the mainActivitysbiCodeDescription to set
	 */
	...
	/**
	 * @param activity1SbiCode the activity1SbiCode to set
	 */
	...
	/**
	 * @param activity1SbiCodeDescription the activity1SbiCodeDescription to set
	 */
	...
	/**
	 * @param activity2SbiCode the activity2SbiCode to set
	 */
	...
	/**
	 * @param activity2SbiCodeDescription the activity2SbiCodeDescription to set
	 */
